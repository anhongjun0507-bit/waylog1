      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <section className={cls("p-4 rounded-2xl border", dark ? "bg-[#121212] border-[#262626]" : "bg-[#fafafa] border-[#dbdbdb]")}>
          <div className="flex items-center justify-between mb-3">
            ...
            {!readOnly && (
              <span className={cls("text-xs font-semibold inline-flex items-center gap-1", dark ? "text-[#a8a8a8]" : "text-[#a8a8a8]")}>
                <Edit3 size={10}/> 수정 가능
              </span>
            )}
          </div>
          <div className="grid grid-cols-2 gap-3">
            {fields.map((f) => (
              <div key={f.key}>
                <label className={cls("text-xs font-semibold block mb-1", dark ? "text-[#a8a8a8]" : "text-[#737373]")}>
          ...
          {!readOnly && (
            <p className={cls("text-xs mt-3", dark ? "text-[#a8a8a8]" : "text-[#a8a8a8]")}>
        ...
        <p className={cls("text-xs text-center pt-2 pb-4", dark ? "text-[#a8a8a8]" : "text-[#a8a8a8]")}>
