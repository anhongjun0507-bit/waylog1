...
| `send-challenge-reminders` | KST 19:00 챌린지 리마인더 (GitHub Actions cron) | ✅ (CRON_SECRET 헤더 자체검증) | `CRON_SECRET` | [send-challenge-reminders/README.md](send-challenge-reminders/README.md) |
...
1.3.0 까지 `--no-verify-jwt` 였던 함수는 이번 배포로 자동 복구됨.
